...
const (
	...
	pingPacket      byte = 1 // pingPacket is not used by XDPoS discovery v4.
	pongPacket      byte = 2
	findnodePacket  byte = 3
	neighborsPacket byte = 4
	pingXDC         byte = 5 // pingXDC is the ping packet for XDPoS discovery v4.
)
