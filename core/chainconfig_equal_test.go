...
func TestHashChainConfigSemanticGoldenVectors(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "testnet", cfg: params.TestnetChainConfig.Clone(), want: "35a976729191b8874412f6469eb4924d419a5078c3bbad65c00166f7b1042393"},
		...
		{name: "testnet-berlin-drift", cfg: testnetBerlinDrift, want: "252fe7a3c7cbb6f9e4cfe32d2453c926c44583b259357d402903e63824e4a340"},
	}
